...
function Login() {
    ...
    const SignInSchema = Yup.object().shape({
        ...
        identifier: Yup.string().required("فیلد ov الزامی است  "),
        password: Yup.string()
    ...
    const handleSubmit = (form) => {
        ...
        axios.post('http://localhost:1337/api/auth/local', form).then(res => {
                    ...
                    return (
                        <div className="d-flex justify-content-center align-items-center" style={{ height: "100vh" }}>
                            ...
                            <Card variant="outlined" sx={{ backgroundColor: "bg1", display: "flex", justifyContent: "center", flexDirection: "column", width: { md: "70%", sm: "100%", lg: "50%", xs: "100%" }, paddingY: "1rem", marginX: { sm: "10px", xs: "10px" } }}>
                                ...
                                <Typography variant="h6" className='my-3' sx={{ color: "text1" }}>صفحه وررود</Typography>
                                ...
                                <Form>
                                    ...
                                    <div className='d-flex flex-column justify-content-center align-items-center'>
                                        ...
                                        <div>
                                            <span>
                                                در حال حاضر حساب ندارید؟
                                            </span>
                                            <Link to={"/register"} style={{ color: "#cc955f" }} className='mx-2'>
                                                ثبت نام کنید
                                            </Link>
                                        </div>
                                    </div> </Form>
